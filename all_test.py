...
fundlist = ['161005','163402','163407','110020','100038','000051','000478','001052','161017','002903','100032','090010','001180','002708','000968','001064','004752','001469','502010','001552','000942','110027','340001','270048','000563','000147','003376','000071','000216']
overseefundlist = ['000614','050025','164906','162411']
etflist =['159938','512980','159920','515180','512880','159940','513050']
...
code =  'codes'
code_time = datetime.datetime.now().strftime("%d/%m/%Y %H:%M:%S")
value = '1'
...
def select_today_price(df,codeColumn,valueColumn,codelist):
  ...
  df.columns = [code_time, value] #rename columns
  return df
...
#toCS
open_df.append(qdii_df).append(etf_df).append(a_stock_df).to_csv(csv_file)
